...
class SmtpEmailService:
    ...
    async def send_password_reset(
        ...
        expire_minutes = self.config.password_reset_expire_minutes
        ...
        message.set_content(
            "Bạn vừa yêu cầu đặt lại mật khẩu Quiz Game.\n\n"
            f"Mở liên kết sau để tiếp tục:\n{reset_link}\n\n"
            f"Liên kết này sẽ hết hạn sau {expire_minutes} phút.\n"
...
<html>
  <body>
    ...
    <p>Liên kết này sẽ hết hạn sau {expire_minutes} phút.</p>
